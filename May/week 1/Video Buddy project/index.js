...
// var hwod= ' https://youtube.googleapis.com/youtube/v3/videos?part=snippet%2CcontentDetails%2Cstatistics%2Cplayer&id=Ks-_Mh1QhMc&key='
  
// var viojioj =' https://developers.google.com/youtube/v3/docs/search/list'


// var hkuhio= 'https://youtube.googleapis.com/youtube/v3/search?part=snippet&maxResults=15&relatedToVideoId=[VIDEO_ID]&type=video&key=[YOUR_API_KEY]'
//  var search='https://youtube.googleapis.com/youtube/v3/search?part=snippet&maxResults=25&q=[SEARCH_STRING]&type=video&key=[YOUR_API_KEY]'

//  const pata ='https://youtube.googleapis.com/youtube/v3/search?part=snippet&maxResults=15&relatedToVideoId=Ks-_Mh1QhMc&type=video&key=[YOUR_API_KEY]'
